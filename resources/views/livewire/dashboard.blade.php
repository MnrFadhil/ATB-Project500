...
@script
    <script>
        const shiftChartData = @json($shiftChart);
        ...
        var dataDebitAirBaku = shiftChartData.map(data1 => data1.flow_meters.filter(data2 => data2.location == null)[0]
            .flow)
        ...
        var totalFlow = shiftChartData.map(data1 => data1.flow_meters.filter(data2 => data2.location !== null)).map(
            data3 => {
                let countTotal = 0;
                data3.forEach(data4 => {
